...
from Deep import Linear, ReLU, MeanSquaredError, GradientDescentOptimizer, CustomModel, Conv
from Deep import Sigmoid, Softmax
from Deep.layer import Pool
from Deep.layer.Flatten import Flatten
import numpy as np
